...
export default function Senha({ passwordRules }: SenhaProps) {
    return (
        <>
            <Head title="Alterar senha — Gestão SEDUR" />
            <div className="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] lg:p-6">
                ...
                <Form action="/gestao/conta/senha" method="put" errorBag="updatePassword" resetOnSuccess>
...
Senha.layout = (page: ReactNode) => <GestaoLayout>{page}</GestaoLayout>;
