...
/**
 * Símbolo da marca Viabiliza: pin de localização com edifício —
 * viabilidade locacional de atividades econômicas. Versão vetorial
 * do conceito em docs/marca/, herda a cor via currentColor
 * (usar text-brand-500).
 */
...
/**
 * Logo horizontal: símbolo + wordmark "VIABILIZA" com subtítulo opcional.
 */
    ...
    return (
        <span className="flex items-center gap-2.5">
            ...
            <span className="flex flex-col leading-tight">
                <span className={textClassName}>VIABILIZA</span>
