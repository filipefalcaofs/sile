...
/**
 * Header do TailAdmin adaptado: toggle da sidebar, tema, notificações
 * e menu do usuário. O console de gestão injeta a busca global em `toolbar`,
 * à esquerda desses controles.
 */
export default function AppHeader({ homeHref, logoutHref, accountHref, toolbar }: AppHeaderProps) {
    ...
    return (
        <header className="sticky top-0 flex w-full bg-white border-gray-200 z-99999 dark:border-gray-800 dark:bg-gray-900 lg:border-b">
            <div className="flex flex-col items-center justify-between grow lg:flex-row lg:px-6">
                <div
                    className={`flex items-center justify-between gap-2 border-b border-gray-200 px-3 py-3 dark:border-gray-800 sm:gap-4 lg:border-b-0 lg:px-0 lg:py-4 ${
                        toolbar ? 'w-full min-w-0 lg:w-auto lg:flex-1 lg:justify-start' : 'w-full lg:w-auto lg:flex-none lg:justify-normal'
                    }`}
                >
                    <button
                        type="button"
                    ...
                    {toolbar ? (
                        <div className="min-w-0 w-full max-w-xl flex-1">{toolbar}</div>
                    ) : (
                ...
                <div
                    ...
                    } w-full items-center justify-between gap-4 px-5 py-4 shadow-theme-md lg:flex lg:w-auto lg:shrink-0 lg:justify-end lg:px-0 lg:py-0 lg:shadow-none`}
                >
