...
<head>
    <meta charset="utf-8">
    <title>Documento de Indeferimento</title>
    <style>
...
<body>
    <div class="cabecalho">
        ...
        <h1>Documento de Indeferimento</h1>
    </div>

    <p class="nota-interna">
        Documento administrativo interno: registra o indeferimento da solicitação de
        viabilidade locacional e a sua fundamentação, para arquivo, atendimento
        presencial e auditoria. Não substitui a notificação oficial ao requerente
    ...
    <div class="secao">
        <h2>Imóvel</h2>
        <div class="campo"><strong>Endereço:</strong> {{ ! empty($imovel['endereco']) ? $imovel['endereco'] : '—' }}</div>
            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <th>Descrição</th>
                        <th style="width: 130px;">Veredito</th>
                    </tr>
                </thead>
                <tbody>
    ...
    @if (count($motivos) > 0)
        <div class="secao">
            <h2>Motivos registrados na análise</h2>
            <ul>
