...
- [ ] **Phase 15: Relatórios e Indicadores** — Dashboard executivo e relatórios exportáveis (EP15) — EM ANDAMENTO (1/15 planos). 15-01 (fundação) concluído em 2026-06-15: openspout ^4.0 + echarts ^6.1 instalados (piso php ^8.3 mantido), migration aditiva de índices dos relatórios (Pitfall 1), 5 parâmetros HU-014 do grupo relatorios (catálogo 90) e 2 permissões (consultar-relatorios + relatorios.produtividade.nominal; 29); testes de seeder verdes; pint limpo.
