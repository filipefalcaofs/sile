...
| 14. Inteligência Artificial | Onda 0 ✓ | Em andamento (Onda 0/fundação + SDK laravel/ai + ponte runtime CONCLUÍDOS — guardião APROVADO; Ondas 1-3/funções bloqueadas: credencial real + dataset SEDUR/DPO + pgvector na Onda 3) | 2026-06-16 (parcial) |
