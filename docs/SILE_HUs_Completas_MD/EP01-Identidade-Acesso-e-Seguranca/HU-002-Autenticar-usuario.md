...
## Objetivo
Permitir acesso seguro aos ambientes Viabiliza Cidadão e Viabiliza Gestão.
...
## Fluxo Principal
1. Usuário ou sistema inicia a funcionalidade **Autenticar usuário**.
...
**Quando** executar a funcionalidade **Autenticar usuário**,  
