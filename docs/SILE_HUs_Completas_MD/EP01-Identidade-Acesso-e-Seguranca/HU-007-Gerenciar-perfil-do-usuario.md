...
## Objetivo
Permitir consulta e atualização de dados pessoais básicos.
...
## Fluxo Principal
1. Usuário ou sistema inicia a funcionalidade **Gerenciar perfil do usuário**.
...
**Quando** executar a funcionalidade **Gerenciar perfil do usuário**,  
