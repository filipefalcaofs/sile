...
## Objetivo
Registrar consentimento e ciência sobre tratamento de dados.

## História de Usuário
**Como** usuário,  
**quero** aceitar os termos de uso e privacidade,  
**para** utilizar o sistema conforme a LGPD.
...
## Fluxo Principal
1. Usuário ou sistema inicia a funcionalidade **Aceitar termo LGPD**.
...
**Quando** executar a funcionalidade **Aceitar termo LGPD**,  
