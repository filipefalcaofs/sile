...
## Objetivo
Identificar bairro oficial.

## História de Usuário
**Como** sistema,  
**quero** identificar bairro,  
**para** compor dados da solicitação.
...
## Fluxo Principal
1. Usuário ou sistema inicia a funcionalidade **Identificar bairro**.
...
**Quando** executar a funcionalidade **Identificar bairro**,  
