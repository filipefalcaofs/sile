...
## Objetivo
Relacionar imóvel ao lote territorial.

## História de Usuário
**Como** sistema,  
**quero** identificar lote,  
...
## Fluxo Principal
1. Usuário ou sistema inicia a funcionalidade **Identificar lote**.
...
**Quando** executar a funcionalidade **Identificar lote**,  
