...
## Objetivo
Indicador de deferimentos.

## História de Usuário
**Como** gestor,  
**quero** consultar taxa de deferimento,  
...
## Fluxo Principal
1. Usuário ou sistema inicia a funcionalidade **Taxa de deferimento**.
...
**Quando** executar a funcionalidade **Taxa de deferimento**,  
