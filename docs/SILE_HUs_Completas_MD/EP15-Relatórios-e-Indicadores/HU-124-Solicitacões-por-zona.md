...
## História de Usuário
**Como** gestor,  
**quero** consultar solicitações por zona,  
**para** identificar concentração territorial.
...
## Fluxo Principal
1. Usuário ou sistema inicia a funcionalidade **Solicitações por zona**.
...
**Quando** executar a funcionalidade **Solicitações por zona**,  
