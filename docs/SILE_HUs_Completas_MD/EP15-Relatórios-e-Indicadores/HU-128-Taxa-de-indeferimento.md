...
## Objetivo
Indicador de indeferimentos.

## História de Usuário
**Como** gestor,  
**quero** consultar taxa de indeferimento,  
**para** identificar gargalos e restrições.
...
## Fluxo Principal
1. Usuário ou sistema inicia a funcionalidade **Taxa de indeferimento**.
...
**Quando** executar a funcionalidade **Taxa de indeferimento**,  
