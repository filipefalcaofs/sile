...
## História de Usuário
**Como** gestor,  
**quero** consultar solicitações por risco,  
**para** avaliar fluxo expresso e análise.
...
## Fluxo Principal
1. Usuário ou sistema inicia a funcionalidade **Solicitações por risco**.
...
**Quando** executar a funcionalidade **Solicitações por risco**,  
