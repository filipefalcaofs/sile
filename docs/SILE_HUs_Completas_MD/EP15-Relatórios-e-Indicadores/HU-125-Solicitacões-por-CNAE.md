...
## História de Usuário
**Como** gestor,  
**quero** consultar solicitações por CNAE,  
**para** entender perfil econômico.
...
## Fluxo Principal
1. Usuário ou sistema inicia a funcionalidade **Solicitações por CNAE**.
...
**Quando** executar a funcionalidade **Solicitações por CNAE**,  
