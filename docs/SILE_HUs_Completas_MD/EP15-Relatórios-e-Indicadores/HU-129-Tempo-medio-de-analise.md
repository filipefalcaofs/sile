...
## Objetivo
Indicador de tempo de tramitação.

## História de Usuário
**Como** gestor,  
**quero** consultar tempo médio,  
...
## Fluxo Principal
1. Usuário ou sistema inicia a funcionalidade **Tempo médio de análise**.
...
**Quando** executar a funcionalidade **Tempo médio de análise**,  
