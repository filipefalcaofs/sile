...
## Objetivo
Indicador por servidor.

## História de Usuário
**Como** gestor,  
**quero** consultar produtividade,  
...
## Fluxo Principal
1. Usuário ou sistema inicia a funcionalidade **Produtividade por analista**.
...
**Quando** executar a funcionalidade **Produtividade por analista**,  
