...
## História de Usuário
**Como** gestor,  
**quero** consultar solicitações por período,  
**para** avaliar demanda.
...
## Fluxo Principal
1. Usuário ou sistema inicia a funcionalidade **Solicitações por período**.
...
**Quando** executar a funcionalidade **Solicitações por período**,  
