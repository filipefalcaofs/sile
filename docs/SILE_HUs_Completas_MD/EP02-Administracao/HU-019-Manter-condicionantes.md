...
## Objetivo
Cadastrar condicionantes por CNAE/regra.

## História de Usuário
**Como** administrador,  
**quero** manter condicionantes,  
**para** parametrizar decisões condicionadas.
...
## Fluxo Principal
1. Usuário ou sistema inicia a funcionalidade **Manter condicionantes**.
...
**Quando** executar a funcionalidade **Manter condicionantes**,  
