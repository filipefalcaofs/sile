...
## Objetivo
Administrar regras do Quadro 10.

## História de Usuário
**Como** administrador,  
**quero** manter Quadro 10,  
**para** permitir análise por via.
...
## Fluxo Principal
1. Usuário ou sistema inicia a funcionalidade **Manter Quadro 10**.
...
**Quando** executar a funcionalidade **Manter Quadro 10**,  
