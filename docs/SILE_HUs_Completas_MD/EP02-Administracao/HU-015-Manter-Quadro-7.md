...
## Objetivo
Administrar regras do Quadro 7.

## História de Usuário
**Como** administrador,  
**quero** manter Quadro 7,  
**para** permitir enquadramento correto.
...
## Fluxo Principal
1. Usuário ou sistema inicia a funcionalidade **Manter Quadro 7**.
...
**Quando** executar a funcionalidade **Manter Quadro 7**,  
