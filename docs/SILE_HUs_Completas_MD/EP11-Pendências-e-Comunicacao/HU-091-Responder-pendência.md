...
## Objetivo
Permitir resposta e anexos complementares.

## História de Usuário
**Como** cidadão,  
**quero** responder pendência,  
...
## Fluxo Principal
1. Usuário ou sistema inicia a funcionalidade **Responder pendência**.
...
**Quando** executar a funcionalidade **Responder pendência**,  
