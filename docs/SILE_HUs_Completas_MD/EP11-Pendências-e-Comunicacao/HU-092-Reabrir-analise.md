...
## Objetivo
Retornar processo para analista após resposta.

## História de Usuário
**Como** sistema,  
**quero** reabrir análise,  
...
## Fluxo Principal
1. Usuário ou sistema inicia a funcionalidade **Reabrir análise**.
...
**Quando** executar a funcionalidade **Reabrir análise**,  
