...
## Objetivo
Avisar prazos de resposta.

## História de Usuário
**Como** sistema,  
**quero** notificar vencimentos,  
...
## Fluxo Principal
1. Usuário ou sistema inicia a funcionalidade **Notificar vencimentos**.
...
**Quando** executar a funcionalidade **Notificar vencimentos**,  
