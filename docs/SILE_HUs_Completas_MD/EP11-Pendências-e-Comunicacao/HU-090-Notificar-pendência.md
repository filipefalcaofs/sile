...
## Objetivo
Comunicar exigência ao cidadão.

## História de Usuário
**Como** sistema,  
**quero** notificar pendência,  
**para** permitir regularização.
...
## Fluxo Principal
1. Usuário ou sistema inicia a funcionalidade **Notificar pendência**.
...
**Quando** executar a funcionalidade **Notificar pendência**,  
