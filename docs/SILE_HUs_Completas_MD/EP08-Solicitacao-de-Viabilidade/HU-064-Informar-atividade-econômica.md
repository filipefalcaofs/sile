...
## Objetivo
Descrever atividade exercida.

## História de Usuário
**Como** cidadão,  
**quero** informar atividade,  
**para** validar compatibilidade com CNAE.
...
## Fluxo Principal
1. Usuário ou sistema inicia a funcionalidade **Informar atividade econômica**.
...
**Quando** executar a funcionalidade **Informar atividade econômica**,  
