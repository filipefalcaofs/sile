...
## Objetivo
Permitir cancelamento antes da conclusão.

## História de Usuário
**Como** cidadão,  
**quero** cancelar solicitação,  
**para** interromper análise indevida ou duplicada.
...
## Fluxo Principal
1. Usuário ou sistema inicia a funcionalidade **Cancelar solicitação**.
...
**Quando** executar a funcionalidade **Cancelar solicitação**,  
