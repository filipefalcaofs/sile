...
## História de Usuário
**Como** cidadão,  
**quero** protocolar solicitação,  
**para** acompanhar oficialmente o processo.
...
## Fluxo Principal
1. Usuário ou sistema inicia a funcionalidade **Protocolar solicitação**.
...
**Quando** executar a funcionalidade **Protocolar solicitação**,  
