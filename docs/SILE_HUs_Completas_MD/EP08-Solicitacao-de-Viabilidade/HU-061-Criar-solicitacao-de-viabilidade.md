...
## História de Usuário
**Como** cidadão,  
**quero** criar solicitação,  
**para** obter análise oficial.
...
## Fluxo Principal
1. Usuário ou sistema inicia a funcionalidade **Criar solicitação de viabilidade**.
...
**Quando** executar a funcionalidade **Criar solicitação de viabilidade**,  
