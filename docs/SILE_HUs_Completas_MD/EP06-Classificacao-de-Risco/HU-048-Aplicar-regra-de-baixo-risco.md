...
## Objetivo
Processar baixo risco conforme regra expressa.

## História de Usuário
**Como** sistema,  
**quero** aplicar baixo risco,  
**para** responder sem análise humana quando elegível.
...
## Fluxo Principal
1. Usuário ou sistema inicia a funcionalidade **Aplicar regra de baixo risco**.
...
- RN-007: Por exigência legal, CNAE enquadrado como baixo risco com todas as condicionantes atendidas DEVE receber finalização expressa (sem análise humana).
- RN-008: As condicionantes gerais mais comuns de baixo risco são: edificação não residencial, área utilizada menor ou igual a 1.250 m² e uso como escritório da empresa — conforme anexo do Decreto Municipal nº 32.636/2020 (redação dada pelo Decreto nº 38.673/2024), fonte oficial confirmada.
- RN-009: Além das condicionantes gerais, cada CNAE pode possuir condicionantes específicas, mantidas em planilha parametrizada pela SEDUR (ver HU-019 e HU-020).

## Critérios de Aceite — BDD

### CA-01 — Execução com sucesso
**Dado** que o usuário possui permissão e informou os dados obrigatórios,  
**Quando** executar a funcionalidade **Aplicar regra de baixo risco**,  
...
Fonte oficial da classificação municipal: Decreto nº 32.636/2020, anexos na redação dos Decretos nº 37.407/2023 e nº 38.673/2024 — todas as 1.331 subclasses CNAE classificadas: 767 Baixo Risco A, 328 Baixo Risco B, 236 Alto Risco, com condicionantes por CNAE (extraído em docs/dados-oficiais/decreto-32636-2020-risco-municipal-unificado-cnae.csv). Confirmar com a SEDUR qual redação dos anexos o sistema atual utiliza.

A Planilha Unificada CNAE 30.04.26 (docs/dados-oficiais/) é a dimensão de risco **sanitário** (VISA): 260 CNAEs distintos, 89 de baixo risco, 18 com condicionante — 52 deles divergem do risco municipal unificado do decreto. Risco sanitário e risco municipal são dimensões distintas no modelo. Em ambas as fontes, a condicionante é uma pergunta autodeclaratória ao requerente cuja resposta pode reclassificar o risco.
