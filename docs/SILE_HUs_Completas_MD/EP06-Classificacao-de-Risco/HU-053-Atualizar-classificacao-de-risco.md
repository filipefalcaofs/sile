...
## Objetivo
Permitir manutenção da tabela de risco.

## História de Usuário
**Como** administrador,  
**quero** atualizar classificação,  
**para** adequar o sistema à legislação vigente.
...
## Fluxo Principal
1. Usuário ou sistema inicia a funcionalidade **Atualizar classificação de risco**.
...
**Quando** executar a funcionalidade **Atualizar classificação de risco**,  
