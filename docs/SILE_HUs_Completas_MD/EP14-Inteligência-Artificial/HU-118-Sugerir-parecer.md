...
## Objetivo
Gerar minuta de parecer não vinculante.

## História de Usuário
**Como** IA,  
**quero** sugerir parecer,  
**para** apoiar decisão humana.
...
## Fluxo Principal
1. Usuário ou sistema inicia a funcionalidade **Sugerir parecer**.
...
**Quando** executar a funcionalidade **Sugerir parecer**,  
