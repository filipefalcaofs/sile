...
## Objetivo
Gerar síntese técnica do processo.

## História de Usuário
**Como** IA,  
**quero** resumir processo,  
**para** agilizar análise.
...
## Fluxo Principal
1. Usuário ou sistema inicia a funcionalidade **Gerar resumo para analista**.
...
**Quando** executar a funcionalidade **Gerar resumo para analista**,  
