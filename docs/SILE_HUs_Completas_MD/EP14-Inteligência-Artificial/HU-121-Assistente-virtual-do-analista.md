...
## Objetivo
Apoiar busca por regras e histórico.

## História de Usuário
**Como** IA,  
**quero** auxiliar analista,  
...
## Fluxo Principal
1. Usuário ou sistema inicia a funcionalidade **Assistente virtual do analista**.
...
**Quando** executar a funcionalidade **Assistente virtual do analista**,  
