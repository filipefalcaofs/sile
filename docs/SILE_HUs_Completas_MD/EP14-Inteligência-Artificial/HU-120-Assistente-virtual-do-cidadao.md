...
## Objetivo
Responder dúvidas do portal.

## História de Usuário
**Como** IA,  
**quero** orientar cidadão,  
...
## Fluxo Principal
1. Usuário ou sistema inicia a funcionalidade **Assistente virtual do cidadão**.
...
**Quando** executar a funcionalidade **Assistente virtual do cidadão**,  
