...
## Objetivo
Identificar tipo do documento anexado.

## História de Usuário
**Como** IA,  
**quero** classificar documentos,  
**para** validar compatibilidade com exigência.
...
## Fluxo Principal
1. Usuário ou sistema inicia a funcionalidade **Classificar documentos**.
...
**Quando** executar a funcionalidade **Classificar documentos**,  
