...
## Objetivo
Traduzir resultado técnico para linguagem simples.

## História de Usuário
**Como** IA,  
**quero** explicar resultado,  
...
## Fluxo Principal
1. Usuário ou sistema inicia a funcionalidade **Explicar resultado ao cidadão**.
...
**Quando** executar a funcionalidade **Explicar resultado ao cidadão**,  
