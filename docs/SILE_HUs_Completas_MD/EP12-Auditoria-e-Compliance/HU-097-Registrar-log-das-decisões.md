...
## Objetivo
Registrar decisões automáticas e manuais.
...
## Fluxo Principal
1. Usuário ou sistema inicia a funcionalidade **Registrar log das decisões**.
...
**Quando** executar a funcionalidade **Registrar log das decisões**,  
