...
## História de Usuário
**Como** auditor,  
**quero** exportar auditoria,  
**para** subsidiar controle interno.
...
## Fluxo Principal
1. Usuário ou sistema inicia a funcionalidade **Exportar auditoria**.
...
**Quando** executar a funcionalidade **Exportar auditoria**,  
