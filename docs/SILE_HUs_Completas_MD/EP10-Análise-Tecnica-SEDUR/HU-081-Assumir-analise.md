...
## Objetivo
Permitir que analista assuma processo.

## História de Usuário
**Como** analista,  
**quero** assumir análise,  
**para** registrar responsabilidade técnica.
...
## Fluxo Principal
1. Usuário ou sistema inicia a funcionalidade **Assumir análise**.
...
**Quando** executar a funcionalidade **Assumir análise**,  
