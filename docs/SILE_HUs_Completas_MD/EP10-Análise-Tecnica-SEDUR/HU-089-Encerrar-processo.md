...
## Objetivo
Finalizar processo após decisão.

## História de Usuário
**Como** sistema,  
**quero** encerrar processo,  
**para** impedir alterações indevidas.
...
## Fluxo Principal
1. Usuário ou sistema inicia a funcionalidade **Encerrar processo**.
...
**Quando** executar a funcionalidade **Encerrar processo**,  
