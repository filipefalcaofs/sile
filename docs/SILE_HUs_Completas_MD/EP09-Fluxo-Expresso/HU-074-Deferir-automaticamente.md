...
## Objetivo
Deferir solicitações conformes.

## História de Usuário
**Como** sistema,  
**quero** deferir automaticamente,  
...
## Fluxo Principal
1. Usuário ou sistema inicia a funcionalidade **Deferir automaticamente**.
...
**Quando** executar a funcionalidade **Deferir automaticamente**,  
