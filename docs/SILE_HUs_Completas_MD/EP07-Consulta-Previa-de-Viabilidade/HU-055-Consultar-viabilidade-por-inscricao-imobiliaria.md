...
## Objetivo
Permitir simulação por inscrição imobiliária.

## História de Usuário
**Como** cidadão,  
**quero** informar inscrição imobiliária,  
**para** localizar o imóvel com maior precisão.
...
## Fluxo Principal
1. Usuário ou sistema inicia a funcionalidade **Consultar viabilidade por inscrição imobiliária**.
...
**Quando** executar a funcionalidade **Consultar viabilidade por inscrição imobiliária**,  
