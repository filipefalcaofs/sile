...
## Objetivo
Simular risco da atividade.

## História de Usuário
**Como** sistema,  
**quero** classificar risco preliminar,  
**para** indicar possibilidade de fluxo expresso.
...
## Fluxo Principal
1. Usuário ou sistema inicia a funcionalidade **Simular classificação de risco**.
...
**Quando** executar a funcionalidade **Simular classificação de risco**,  
