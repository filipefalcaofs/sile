...
## Objetivo
Permitir consulta preliminar por atividade econômica.

## História de Usuário
**Como** cidadão,  
**quero** informar CNAE,  
**para** entender restrições antes de protocolar.
...
## Fluxo Principal
1. Usuário ou sistema inicia a funcionalidade **Consultar viabilidade por CNAE**.
...
**Quando** executar a funcionalidade **Consultar viabilidade por CNAE**,  
