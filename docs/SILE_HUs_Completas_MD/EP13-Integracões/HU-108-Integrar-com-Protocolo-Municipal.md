...
## Objetivo
Registrar protocolo em sistema oficial quando necessário.

## História de Usuário
**Como** sistema,  
**quero** integrar com protocolo,  
**para** centralizar tramitação municipal.
...
## Fluxo Principal
1. Usuário ou sistema inicia a funcionalidade **Integrar com Protocolo Municipal**.
...
**Quando** executar a funcionalidade **Integrar com Protocolo Municipal**,  
