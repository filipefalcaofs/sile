...
## Objetivo
Permitir atualização de dados complementares da empresa.

## História de Usuário
**Como** usuário autorizado,  
**quero** atualizar dados da empresa,  
...
## Fluxo Principal
1. Usuário ou sistema inicia a funcionalidade **Atualizar dados empresariais**.
...
**Quando** executar a funcionalidade **Atualizar dados empresariais**,  
