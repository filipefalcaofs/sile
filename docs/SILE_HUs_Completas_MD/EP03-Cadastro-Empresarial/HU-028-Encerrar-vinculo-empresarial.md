...
## Objetivo
Permitir encerramento de vínculo do usuário com empresa.

## História de Usuário
**Como** usuário autorizado,  
**quero** encerrar vínculo com empresa,  
**para** remover acesso indevido ou desnecessário.
...
## Fluxo Principal
1. Usuário ou sistema inicia a funcionalidade **Encerrar vínculo empresarial**.
...
**Quando** executar a funcionalidade **Encerrar vínculo empresarial**,  
