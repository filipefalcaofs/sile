...
## Objetivo
Registrar CNAE principal da atividade.

## História de Usuário
**Como** usuário,  
**quero** informar CNAE principal,  
**para** permitir análise de viabilidade.
...
## Fluxo Principal
1. Usuário ou sistema inicia a funcionalidade **Vincular CNAE principal**.
...
**Quando** executar a funcionalidade **Vincular CNAE principal**,  
