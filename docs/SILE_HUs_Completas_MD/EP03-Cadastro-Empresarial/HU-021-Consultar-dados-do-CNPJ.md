...
## Objetivo
Consultar dados cadastrais de empresa a partir do CNPJ.

## História de Usuário
**Como** usuário,  
**quero** consultar dados do CNPJ,  
**para** preencher automaticamente dados empresariais.
...
## Fluxo Principal
1. Usuário ou sistema inicia a funcionalidade **Consultar dados do CNPJ**.
...
**Quando** executar a funcionalidade **Consultar dados do CNPJ**,  
