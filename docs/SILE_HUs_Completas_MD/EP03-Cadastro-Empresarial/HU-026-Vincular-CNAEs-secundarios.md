...
## Objetivo
Registrar CNAEs secundários.

## História de Usuário
**Como** usuário,  
**quero** informar CNAEs secundários,  
**para** analisar todas as atividades pretendidas.
...
## Fluxo Principal
1. Usuário ou sistema inicia a funcionalidade **Vincular CNAEs secundários**.
...
**Quando** executar a funcionalidade **Vincular CNAEs secundários**,  
