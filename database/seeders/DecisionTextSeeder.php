...
class DecisionTextSeeder extends Seeder
{
    ...
    private const DESCRICOES = [
        ...
        'louos.motivo.sem_enquadramento_consolidado' => 'Motivo do consolidado pendente quando o CNAE não tem enquadramento no Quadro 7.',
        ...
        'louos.motivo.sem_enquadramento' => 'Motivo da dimensão Quadro 10 quando não há enquadramento do Quadro 7 a verificar.',
        ...
        'louos.template.quadro7' => 'Template do motivo da classificação do Quadro 7. Placeholders: :cnae, :area, :grupo, :subgrupo, :faixa.',
        ...
        'explicacao.motivo.quadro7_nao_registrado' => 'Motivo do passo do Quadro 7 não registrado na decisão legada.',
        ...
        'explicacao.motivo.permitido_so_quadro7' => 'Motivo da consolidação legada permitida que cita só o Quadro 7.',
